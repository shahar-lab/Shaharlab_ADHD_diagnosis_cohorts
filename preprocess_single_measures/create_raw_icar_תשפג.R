...
icar <- read_tsv("data/תשפג/collected_data/ICAR16+Hebrew+-+Copy_October+1,+2025_10.03_values.tsv",
...
# 2. Takeout subjectid duplicates by retaining only the first line for those how complete the whole thing twice
...
#### SAVE ----
save(icar, file = 'data/תשפג/raw_data/icar.Rdata')
