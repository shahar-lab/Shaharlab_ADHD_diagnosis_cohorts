...
#load 
stai <- read_tsv("data/תשפג/collected_data/STAI+template+-+עברית+-+Copy_October+1,+2025_10.00_values.tsv",
...
#### SAVE ----
save(stai, file = 'data/תשפג/raw_data/stai.Rdata')
