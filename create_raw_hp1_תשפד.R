...
# load 
hp1 <- read_tsv("data/תשפד/collected_data/דמוגרפי,+EHI,+AUDIT,+CUDIT-R_May+31,+2025_13.39.tsv",
...
hp1 <- hp1 |>
  ...
  # Demographic
  rename(age       = demographic1_age,
         gender    = demographic3_gender,
         education = demographic4_educati,
         place_of_residence_until12yo = demographic7_residen,
...
#### SAVE ----
save(hp1, file = 'data/תשפד/raw_data/hp1.Rdata')
